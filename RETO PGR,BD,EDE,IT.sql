...
("Asus GT710","Graphics",5,81.99),
("Intel Core i5-13400","Processor",6,170),
("ESC 4000 G4X","RAM",5,110.99),
("OFFTEK 8GB","RAM",5,30),
("ASUS Dual RTX 4060 TI","Graphics",5,81.99),
("Ultra 9 285K","Processor",6,665);
