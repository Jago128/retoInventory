...
DELIMITER //
CREATE FUNCTION sellAndSubstractProduct(CODUSER VARCHAR(20), NAMEPROD VARCHAR(50), AMOUNT INT, TOTALPRICE DOUBLE, COMP BOOLEAN) RETURNS VARCHAR(255)
READS SQL DATA
BEGIN
...
DELIMITER //
CREATE FUNCTION sellAndSubstractComponent(CODUSER VARCHAR(20), NAMEC VARCHAR(50), AMOUNT INT) RETURNS VARCHAR(255)
READS SQL DATA
BEGIN
	DECLARE CURRENTSTOCK INT DEFAULT 0;
    DECLARE STOCKCHECK INT DEFAULT 0;
